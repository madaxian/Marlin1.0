...
#define Linkage_1 59 //mm      Preprocessor cannot handle decimal point...
...
#define X_MAX_POS 300//129.5
#define X_MIN_POS -300//69.5
#define Y_MAX_POS 300//50.2
#define Y_MIN_POS -300//-50.2
#define Z_MAX_POS 64.72
...
#define MANUAL_X_HOME_POS 139.0//-139.0
...
#define HOMING_FEEDRATE {40*60, 40*60, 10*60/2, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {14*8.88889,3.7*8.88889,3200/4,1000}//#define DEFAULT_AXIS_STEPS_PER_UNIT   {103.69,106.65,200/1.25,1000}  // default steps per unit for SCARA
